  ...
  return (
    <div className="space-y-4">
      ...
      <details className="rounded-xl border border-slate-200 bg-white px-3 py-2 text-xs text-slate-600">
        ...
        <p className="mt-2">Every shift names two roles: the <strong>college instructor</strong> (on an instructor-led shift) and the <strong>site preceptor</strong> (on a precepted one); a combined model needs both. A role the template does not require reads <em>none required</em>, never a gap. The hours are attributed by share: a supervisor&apos;s hours on the shift ÷ the learners on that shift is each learner&apos;s share, credited only when someone is named in the role, so a site&apos;s or a person&apos;s total is the time they actually gave, not the shift length × learners. On a precepted rotation the college instructor of record oversees the learner for the template&apos;s fraction of the shift (Radiography&apos;s 0.04 of an instructor: about 19 minutes of an 8-hour shift), and is named on every shift like any other role.</p>
      </details>
