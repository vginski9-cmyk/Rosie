...
export default async function FamilyProgramsPage({ params }: { params: { id: string } }) {
  ...
  return (
    <div className="space-y-8">
      <div>
        ...
        <h1 className="mt-1 text-2xl font-semibold tracking-tight">Credentials &amp; delivery models</h1>
        <p className="max-w-3xl text-sm text-slate-500">
          The program templates delivering toward {family.occupation?.title ?? family.name} — grouped by credential
          (AAS / Diploma / Certificate). Each delivery model is a term structure you can design; create a new one below.
        </p>
      </div>
