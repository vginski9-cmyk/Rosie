...
export const NC_PLACES: Record<string, LatLng> = {
  ...
  "new bern": { lat: 35.1085, lng: -77.0441 }, "beaufort": { lat: 34.7182, lng: -76.6638 }, "newport": { lat: 34.7868, lng: -76.8619 }, "havelock": { lat: 34.8790, lng: -76.9013 }, "snow hill": { lat: 35.4513, lng: -77.6789 }, "trenton": { lat: 35.0674, lng: -77.3527 }, "la grange": { lat: 35.3068, lng: -77.7886 }, "elizabeth city": { lat: 36.2946, lng: -76.2510 }, "jacksonville": { lat: 34.7541, lng: -77.4302 }, "rocky mount": { lat: 35.9382, lng: -77.7905 }, "winston-salem": { lat: 36.0999, lng: -80.2442 },
