...
export const SETTING_PRESETS: [string, string, string][] = [
  ...
  ["ORS", "Operating room suite", "OR suite"], ["ENDO", "Endoscopy / GI procedure suite", "Endoscopy procedure room"], ["BEDS", "Medical-surgical / telemetry unit", "Med-surg nursing unit"], ["ICU", "Intensive / critical care unit", "ICU nursing unit"], ["OB", "Labor & delivery / mother-baby", "L&D and postpartum unit"],
